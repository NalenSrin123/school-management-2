...
function Instructor() {
   const card=[
        ...
        },
        {
            ...
            detail:"Former software architect with a for pedagogy.",

        }
    ];
  return (
    <div className="w-full mt-13 p-3">
        ...
        <div className="grid grid-cols-4 w-full h-112.5 gap-4">
            {card.map((value)=>(
                ...
                <div className="mt-2">
                    ...
                    <div className='text-blue-500'>{value.position}</div>
                    <div className='text-gray-600 mt-2'>{value.detail}</div>
                </div>
            </div>
            ))}
        </div>
